...
pub const fn make_keymap() -> Layers {
    ...
    const KEYMAP: Layers = [
        ...
        [
            ...
            [NoOp,    k(F11),  k(F12),  k(F13),  k(F14),  k(F15),  NK,    /*|*/ NK,      K_PGUP,  k(Home), K_UP,     k(End),  NoOp,    NoOp,    ],
        ...
        // Symbols / Keypad 
        [
            [NoOp,    K_QUMK,  K_COLN,  K_AMP,   K_HASH,  K_NUBS,  NK,    /*|*/ NK,      K_TILD,  K_7,     K_8,      K_9,     K_LBRK,  K_RBRK,  ],
            [NoOp,    NoOp,    NoOp,    NoOp,    K_MUL,   K_DIV,   NK,    /*|*/ NK,      K_NUBS,  K_4,     K_5,      K_6,     K_LBRA,  K_RBRA,  ],
            [K_LSHFT, NoOp,    NoOp,    NoOp,    K_PLUS,  K_MINUS, NK,    /*|*/ NK,      K_BKTK,  K_1,     K_2,      K_3,     K_LPAR,  K_RPAR,  ],
            [K_LCTRL, NoOp,    NoOp,    NoOp,    NoOp,    K_EQ,    K_ENT, /*|*/ K_BSP,   K_PIPE,  NoOp,    K_0,      k(Dot),  K_LT,    K_GT,    ],
